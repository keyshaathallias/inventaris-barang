  ...
  <div class="sidebar-wrapper active">
    ...
    <div class="sidebar-menu">
      <ul class="menu">
        ...
        <li class="sidebar-item {{ Request::is('dashboard', 'tambah-pengguna') ? 'active' : '' }}">
        ...
        <li class="sidebar-item {{ Request::is('pembelian', 'tambah-pembelian', 'pembelian/*/edit') ? 'active' : '' }}">
        ...
        @if (Auth::user()->roles == 'administrator' || Auth::user()->roles == 'operator')
          <li
            class="sidebar-item {{ Request::is('pemakaian', 'tambah-pemakaian', 'pemakaian/*/edit') ? 'active' : '' }}">
        ...
        @if (Auth::user()->roles == 'administrator')
          <li class="sidebar-item {{ Request::is('barang', 'tambah-barang', 'barang/*/edit') ? 'active' : '' }}">
          ...
          <li class="sidebar-item {{ Request::is('user', 'user/create', 'user/*/edit') ? 'active' : '' }}">
